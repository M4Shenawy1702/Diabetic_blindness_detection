        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalRedation = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Patients_UserId", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Observations_Doctors_DId",
                        column: x => x.DId,
                        principalTable: "Doctors",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Observations_Patients_PId",
                        column: x => x.PId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Observations_ObservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Observations_DId",
                table: "Observations",
                column: "DId");

            migrationBuilder.CreateIndex(
                name: "IX_Observations_PId",
                table: "Observations",
                column: "PId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_ObservationId",
                table: "Payments",
